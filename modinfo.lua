...
configuration_options =
{
    ...
    },
	{
        ...
        options =
        {
            ...
            {description = "Normal(125)", data = "normal"},
    ...
    },
	{
		...
		{description = "SpearVisual", data = 2},
    ...
    },
	{
        name = "stop_spawning",
        label = "Dall: servant",
		hover = "[No spawn]:Moontree(Dall) stop spawning his servant and plants\n[Small Radius]: the plants are summoned in a small radius. ",
        options =
        {
